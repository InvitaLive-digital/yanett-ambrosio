    ...
    function updateAttendanceVisual() {
        ...
        if (submitBtn) {
            if (typeof isAttending !== 'undefined') {
                if (isAttending === true) {
                    submitBtn.textContent = 'CONFIRMAR ASISTENCIA';
                    submitBtn.className = 'btn btn-dark font-weight-bold';
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (ok) {
               let successMessage = '';
                if (isAttending === true) {
                    successMessage = '¡Confirmación registrada exitosamente! Se envió un email de confirmación. ¡Gracias!';
                } else {
                    successMessage = '¡Tu mensaje ha sido enviado! Se envió un email con tus saludos. ¡Gracias!';
                }
